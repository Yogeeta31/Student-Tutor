...
module.exports.search_tutor_get = async (req, res) => {
  ...
  //Separating concern of each conditions in different modules/functions. For eg: Sorting and searching concern could be decoupled if they dont have dependencies with each other.
  //Use of Switch conditions wherever its possible instead of multiple if.else. conditions.
